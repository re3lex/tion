(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('http'), require('https'), require('url'), require('assert'), require('stream'), require('tty'), require('util'), require('os'), require('zlib'), require('querystring')) :
  typeof define === 'function' && define.amd ? define(['http', 'https', 'url', 'assert', 'stream', 'tty', 'util', 'os', 'zlib', 'querystring'], factory) :
  (global = global || self, global.TionAPI = factory(global.http, global.https, global.url, global.assert, global.stream, global.tty, global.util, global.os, global.zlib, global.qs));
}(this, (function (http, https, url, assert, stream, tty, util, os, zlib, qs) { 'use strict';
  ...
  class TionAPI {
    ...
    doAuthorization() {
      ...
      return axios$1.post('https://api2.magicair.tion.ru/idsrv/oauth2/token', qs.stringify(requestData), config)
        .then((resp) => {
    ...
    getData(force) {
      ...
      this.data = undefined;
      return axios$1.get('https://api2.magicair.tion.ru/location', { headers: this.getHeaders() })
        .then((resp) => {
          const { status, data } = resp;
          if (status === 200) {
